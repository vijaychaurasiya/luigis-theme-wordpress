...
<section class="bg-1 h-900x main-slider pos-relative" style="background:url('<?php the_post_thumbnail_url();?>') !important;">
        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white">
                                ...
                                <h5><a href="#" class="btn-primaryc plr-25"><b><?php echo $hero['link_text'];?></b></a></h5>
                        </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
        </div><!-- container -->
</section>
